...
### Fixed
- Roll back provider skill links when a host link operation fails, preventing partial installs.
...
### Fixed
- Refuse to update dirty or diverged source checkouts, and fail clearly when fetch, version inspection, or fast-forward validation cannot safely complete.
...
### Fixed
- Make installer skill links absolute for relative `HYPERFLOW_HOME` values and preflight all OpenCode targets before creating any links.
...
### Added
- Deterministic memory compact and cold-archive helper

### Changed
- Refresh AGENTS.md doctrine stamp for v5.25.0


### Added
- Deterministic memory auto-archive / compact helper (`scripts/memory-compact.py`)
...
[Unreleased]: https://github.com/Mohammed-Abdelhady/hyperflow/compare/v6.6.4...HEAD

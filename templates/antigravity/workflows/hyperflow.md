---
description: Hyperflow orchestration — apply the doctrine and route the request to the right phase (plan/design/dispatch/audit/trace/deploy)
---
...
- "enhance/improve/rewrite this prompt" / brainstorm / explore / "should we" / scope / decompose / "plan out" / "break down" → `/hyperflow-plan`
- design a UI / visual system / "make it look good" / "design the screen" → `/hyperflow-design`
